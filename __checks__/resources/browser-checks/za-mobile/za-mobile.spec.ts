...
//     const diff1 = Math.abs(pageHeight - 13000);
...
//   await page.goto("https://www.glamira.co.za/glamira-pendant-elsie.html?alloy=red_white-585&stone1=blackdiamond&bypass_varnish=1", { waitUntil: 'domcontentloaded' });
...
//   await page.goto("https://www.glamira.co.za", { waitUntil: 'domcontentloaded' });
//   await page.evaluate(() => window.scrollTo(0, 2000))
//   await page.waitForTimeout(1000);
//   await page.evaluate(() => window.scrollTo(5000, 0))
//   await page.waitForTimeout(3000);
...
//   await page.goto("https://www.glamira.co.za/glamira-pendant-elsie.html?alloy=red_white-585&stone1=blackdiamond", { waitUntil: 'domcontentloaded' });
//   await goToPageCompareHeight()
//   const canoical = page.locator("//link[@rel='canonical']")
//   const hreflang = page.locator("(//link[@hreflang='en-ZA'])")
//   const linkCanoical = await canoical.getAttribute("href")
//   const linkHref = await hreflang.getAttribute("href")
//   await expect(linkCanoical).toEqual("https://www.glamira.co.za/glamira-pendant-elsie.html?alloy=red_white-585&stone1=blackdiamond")
...
//   await username.fill("ly+co.za@onlinebizsoft.com")
...
test("Check the flow of store activities", async ({ page }) => {
  ...
  const userName = "ly+co.za@onlinebizsoft.com"
  const password = "Linh@123"
  const titleRemoveSuccess = "Shopping Bag is Empty" // thay text theo ngôn ngữ store ( giỏ hàng đang trống)
  const URL_STORE = "https://www.glamira.co.za" // thay url store
  const URL_PRODUCT_PAGE = "https://www.glamira.co.za/diamond-rings/"
  const URL_CHECK_OUT_CART = "https://www.glamira.co.za/checkout/cart/"
  const URL_CHECK_OUT_LOGIN_PAGE =
    "https://www.glamira.co.za/checkout/#login-address"
  ...
  const BUTTON_ALL_WOMEN_JEWELLERY = await page.locator(
    'a.pagebuilder-button-link[href="https://www.glamira.co.za/women/"]',
  )
