...
//     await expect(diff1).toBeLessThan(400);
...
//   await page.goto("https://www.glamira.africa/fr/glamira-pendant-elsie.html?alloy=red_white-585&stone1=diamond-Brillant&bypass_varnish=1", { waitUntil: 'domcontentloaded' });
//   await goToPageCompareHeight()
//   await page.goto("https://www.glamira.africa/fr/glamira-pendant-elsie.html?alloy=red_white-585&stone1=diamond-Brillant&utm_source=monitoring", { waitUntil: 'domcontentloaded' });
//   await goToPageCompareHeight()
//   await page.goto("https://www.glamira.africa/fr", { waitUntil: 'domcontentloaded' });

//   await page.click("//a[contains(@class,'main menu_node_33366__link')]");
//   await page.waitForSelector("//div[@data-content-type='button-item']//span[text()='Colliers']")
//   await page.click("//div[@data-content-type='button-item']//span[text()='Colliers']")
...
//   await page.click("//div[@id='content_filter_more_selected']//li[@class='item label  filter-diamonds']//a[text()='Diamants']")
//   await page.waitForTimeout(100);
//   await page.click("//div[@id='content_filter_more_selected']//label[text()='Diamant Noir']")
//   await page.waitForLoadState('load');
...
//   await page.goto("https://www.glamira.africa/fr/glamira-pendant-elsie.html?alloy=red_white-585&stone1=blackdiamond", { waitUntil: 'domcontentloaded' });
//   // await goToPageCompareHeight()
//   const canoical = page.locator("//link[@rel='canonical']")
//   const hreflang = page.locator("(//link[@hreflang='fr-CF'])")
//   const linkCanoical = await canoical.getAttribute("href")
//   const linkHref = await hreflang.getAttribute("href")
//   await expect(linkCanoical).toEqual("https://www.glamira.africa/fr/glamira-pendant-elsie.html?alloy=red_white-585&stone1=blackdiamond")
...
//   await page.waitForTimeout(500);
//   await page.locator("//div[@id='stone']//span[text()='Diamant']").click()
...
//   await username.fill("ly+fr@onlinebizsoft.com")
...
//   // await page.waitForLoadState('load');
//   // const shipping = "#shipping > div.step-content > form > div > div > button"
//   // await page.waitForSelector(shipping);
//   // await page.locator( shipping).click()
//   // await page.waitForLoadState('load');
//   // await page.waitForTimeout(2000);
//   // await page.waitForSelector("//label[@for='adyen_cc']");
//   // await page.locator( "//label[@for='adyen_cc']").click()
//   // await page.waitForLoadState('load');
//   // await page.waitForTimeout(5000);
//   // expect(await page.frameLocator("iframe").locator("//input[@data-fieldtype='encryptedCardNumber']").count()).toBe(1);
...
test("Check the flow of store activities", async ({ page }) => {
  ...
  const userName = "ly+fr@onlinebizsoft.com"
  const password = "Linh@123"
  const titleRemoveSuccess = "Le panier est vide" // thay text theo ngôn ngữ store ( giỏ hàng đang trống)
  const URL_STORE = "https://www.glamira.africa/fr" // thay url store
  const URL_PRODUCT_PAGE = "https://www.glamira.africa/fr/bagues-en-diamant/"
  const URL_CHECK_OUT_CART = "https://www.glamira.africa/fr/checkout/cart/"
  const URL_CHECK_OUT_LOGIN_PAGE =
    "https://www.glamira.africa/fr/checkout/#login-address"
  ...
  const BUTTON_ALL_WOMEN_JEWELLERY = await page.locator(
    'a.pagebuilder-button-link[href="https://www.glamira.africa/fr/femmes/"]',
  ) // thay text theo ngôn ngữ store
  ...
  const PAYMENT_STRIPE = await page.locator(
    "//div[@class='payment-stripes-group']",
  )
  const PAYMENT_WITH_CREDIT_CARD = await page.locator(
    "//div[@class='payment-method stripe-payments _separate']//div[@class='payment-method-title field choice']//label[@for='stripe_payments_card']",
  )
  ...
  async function ClickProcessAndCheckPayment() {
    ...
    await expect(PAYMENT_STRIPE).toBeVisible()
