...
//     }
//   }
//   await page.goto("https://www.glamira.com.tw/en/glamira-bracelet-tanel.html?alloy=white_red-375&stone1=diamond-Brillant&bypass_varnish=1", { waitUntil: 'domcontentloaded' });
//   await compareHeight(9250)
//   await page.waitForTimeout(300)
//   await page.goto("https://www.glamira.com.tw/en/");
...
//   await page.waitForLoadState('load')
//   const priceInListing = await page.locator("//a[contains(@title,\"Black Diamond Women's Bracelet Tressa\")]//following::span[@class='price'][1]").textContent()
//   await page.locator("(//a[contains(@title,\"Black Diamond Women's Bracelet Tressa\")]//span)[1]").click()
//   await page.waitForLoadState('load')
...
//   const hreflang = page.locator("(//link[@hreflang='en-TW'])")
...
//   await username.fill("cuong+tw/en@onlinebizsoft.com")
...
test("Check the flow of store activities", async ({ page }) => {
  ...
  const userName = "cuong+tw/en@onlinebizsoft.com"
  const password = "Duccuong7."
  const titleRemoveSuccess = "Shopping Bag is Empty" // thay text theo ngôn ngữ store ( giỏ hàng đang trống)
  const URL_STORE = "https://www.glamira.com.tw/en/" // thay url store
  const URL_PRODUCT_PAGE = "https://www.glamira.com.tw/en/diamond-rings/"
  const URL_CHECK_OUT_CART = "https://www.glamira.com.tw/en/checkout/cart/"
  const URL_CHECK_OUT_LOGIN_PAGE =
    "https://www.glamira.com.tw/en/checkout/#login-address"
