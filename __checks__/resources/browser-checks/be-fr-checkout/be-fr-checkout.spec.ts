...
//     const difference = Math.abs(pageHeight - 9350);
...
//     }
//   }
//   await page.goto("https://www.glamira.be/fr/glamira-bracelet-tanel.html?alloy=white_red-375&stone1=diamond-Brillant&bypass_varnish=1", { waitUntil: 'domcontentloaded' });
//   await compareHeight()
//   // await page.goto("https://www.glamira.be/fr/glamira-bracelet-tanel.html?alloy=white_red-375&stone1=diamond-Brillant&utm_source=monitoring", { waitUntil: 'domcontentloaded' });
//   // await compareHeight()
//   await page.waitForTimeout(300)
//   await page.goto("https://www.glamira.be/fr/");
//   await page.waitForLoadState('load')
//   await page.locator("//div[@class='top-menu']//a[@title='Bijoux']").click()
//   await page.waitForLoadState('load')
//   await page.waitForTimeout(100)
//   await page.locator("(//nav[@id='menu_mega']//a[@title='Bracelets'])[1]").click()
//   await page.waitForLoadState('load')
...
//   await page.waitForLoadState('load')
//   const priceInListing = await page.locator("//a[@title='Bracelet pour femme Tanel Diamant']//following::span[@class='price'][1]").textContent()
//   await page.locator("(//a[@title='Bracelet pour femme Tanel Diamant']//span)[1]").click()
//   await page.waitForLoadState('load')
...
//   const hreflang = page.locator("(//link[@hreflang='fr-BE'])")
...
//   // Add to cart
//   await page.waitForTimeout(300);
//   await page.locator("(//div[@id='stone']//label[@class='item-label'])[3]").click()
...
//   await page.waitForTimeout(500)
//   await username.fill("cuong+be/fr@onlinebizsoft.com")
...
test("Check the flow of store activities", async ({ page }) => {
  ...
  const userName = "cuong+be/fr@onlinebizsoft.com"
  const password = "Duccuong7."
  const titleRemoveSuccess = "Le panier est vide" // thay text theo ngôn ngữ store ( giỏ hàng đang trống)
  const URL_STORE = "https://www.glamira.be/fr/" // thay url store
  const URL_PRODUCT_PAGE = "https://www.glamira.be/fr/bagues-en-diamant/"
  const URL_CHECK_OUT_CART = "https://www.glamira.be/fr/checkout/cart/"
  const URL_CHECK_OUT_LOGIN_PAGE =
    "https://www.glamira.be/fr/checkout/#login-address"
  ...
  const BUTTON_ALL_WOMEN_JEWELLERY = await page.locator(
    'a.pagebuilder-button-link[href="https://www.glamira.be/fr/femmes/"]',
  ) // thay text theo ngôn ngữ store
      ...
      anchors
        .filter((a) => {
          ...
          return (
            ...
            !href.startsWith("https://www.glamira.be/fr/bracelets/diamant/bracelet_chaine/") &&
            !href.startsWith("https://www.glamira.be/fr/bracelets/diamant/bracelet_riviere/") &&
            !href.startsWith("https://www.glamira.be/fr/bagues-de-promesse/925-silver/") &&
