...
//     }
//   }
//   // await page.goto("https://www.glamira.com.bh/glamira-bracelet-tanel.html?alloy=white_red-375&stone1=diamond-Brillant&no_cache=1", { waitUntil: 'domcontentloaded' });
//   // await compareHeight()
//   await page.goto("https://www.glamira.com.bh/glamira-bracelet-tanel.html?alloy=white_red-375&stone1=diamond-Brillant&bypass_varnish=1", { waitUntil: 'domcontentloaded' });
//   await compareHeight(9450)
//   await page.waitForTimeout(300)
//   await page.goto("https://www.glamira.com.bh");
//   await page.waitForLoadState('load')
//   await page.locator("//div[@class='top-menu']//a[@title='Jewellery']").click()
//   await page.waitForLoadState('load')
//   await page.waitForTimeout(300)
...
//   await page.waitForLoadState('load')
//   const priceInListing = await page.locator("//a[contains(@title,'Black Diamond') and contains(@title,'Bracelet Tressa')]//following::span[@class='price'][1]").textContent()
...
//   const hreflang = page.locator("//link[@hreflang='en-BH']")
...
//   await username.fill("cuong+bh@onlinebizsoft.com")
...
test("Check the flow of store activities", async ({ page }) => {
  ...
  const userName = "cuong+bh@onlinebizsoft.com"
  const password = "Duccuong7."
  const titleRemoveSuccess = "Shopping Bag is Empty" // thay text theo ngôn ngữ store ( giỏ hàng đang trống)
  const URL_STORE = "https://www.glamira.com.bh/" // thay url store
  const URL_PRODUCT_PAGE = "https://www.glamira.com.bh/diamond-rings/"
  const URL_CHECK_OUT_CART = "https://www.glamira.com.bh/checkout/cart/"
  const URL_CHECK_OUT_LOGIN_PAGE =
    "https://www.glamira.com.bh/checkout/#login-address"
  ...
  const BUTTON_ALL_WOMEN_JEWELLERY = await page.locator(
    'a.pagebuilder-button-link[href="https://www.glamira.com.bh/women/"]',
  ) // thay text theo ngôn ngữ store
  ...
  const PAYMENT = await page.locator("#checkout-payment-method-load")
